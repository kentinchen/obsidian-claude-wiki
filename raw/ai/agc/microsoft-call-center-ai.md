---
title: "microsoft/call-center-ai: Send a phone call from AI agent, in an API call. Or, directly call the bot from the configured phone number!"
source: "https://github.com/microsoft/call-center-ai"
author:
published:
created: 2026-04-17
description: "Send a phone call from AI agent, in an API call. Or, directly call the bot from the configured phone number! - microsoft/call-center-ai"
tags:
  - "clippings"
---
## Call Center AI
...
[![Last release date](https://camo.githubusercontent.com/c82810d9b736d90e6afbe3f079de42f83191997c410c1c33d78fd7005f992e8e/68747470733a2f2f696d672e736869656c64732e696f2f6769746875622f72656c656173652d646174652f636c656d6c65736e652f63616c6c2d63656e7465722d6169)](https://github.com/clemlesne/call-center-ai/releases)
...
[![French demo](https://camo.githubusercontent.com/114275eea9d479166512e42f8a9f54991842eacd51ecfb2921f6518387649048/68747470733a2f2f696d672e796f75747562652e636f6d2f76692f695f71684e6455557853492f6d617872657364656661756c742e6a7067)](https://youtube.com/watch?v=i_qhNdUUxSI)
...
[![User report](https://github.com/microsoft/call-center-ai/raw/main/docs/user_report.png)](https://github.com/microsoft/call-center-ai/blob/main/docs/user_report.png)
...
Fill the template from the example at [`config-remote-example.yaml`](https://github.com/microsoft/call-center-ai/blob/main/config-remote-example.yaml). The file should be placed at the root of the project under the name `config.yaml`. It will be used by install scripts (incl. Makefile and Bicep) to configure the Azure resources.
...
If the solution is not running online, fill the template from the example at [`config-local-example.yaml`](https://github.com/microsoft/call-center-ai/blob/main/config-local-example.yaml). The file should be placed at the root of the project under the name `config.yaml`.
...
| **created\_at** | `Edm.String` | Yes | No |  |  |
| **document\_synthesis** | `Edm.String` | Yes | Yes |  |  |
| **file\_path** | `Edm.String` | Yes | No |  |  |
