---
title: "kevinho/clawfeed: ClawFeed — AI-powered news digest with structured summaries from Twitter/RSS feeds and web dashboard"
source: "https://github.com/kevinho/clawfeed"
author:
published:
created: 2026-04-16
description: "ClawFeed — AI-powered news digest with structured summaries from Twitter/RSS feeds and web dashboard - kevinho/clawfeed"
tags:
  - "clippings"
---
## ClawFeed
...
![Dashboard](https://github.com/kevinho/clawfeed/raw/main/docs/demo.gif)
...
See [docs/ARCHITECTURE.md](https://github.com/kevinho/clawfeed/blob/main/docs/ARCHITECTURE.md) for multi-tenant design and scale analysis.

## Roadmap

See [ROADMAP.md](https://github.com/kevinho/clawfeed/blob/main/ROADMAP.md) or the in-app roadmap page.
